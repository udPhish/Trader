...
struct Inherit
    : public Pack::InheritPack<Pack::Pack<Descriptor<_Bases, _Leaf>...>>
{
...
template<class _Self, class _Leaf>
  requires requires
  {
    typename Descriptor<_Self, _Leaf>::DirectBases;
  }
struct SelectDirectBases<_Self, _Leaf>
{
  using Type = typename Descriptor<_Self, _Leaf>::DirectBases;
};
template<class _Self, class _Leaf>
struct SelectTags
{
...
template<class _Self, class _Leaf>
  requires requires
  {
    typename Descriptor<_Self, _Leaf>::Tags;
  }
struct SelectTags<_Self, _Leaf>
{
  using Type = typename Descriptor<_Self, _Leaf>::Tags;
};
template<class... _Ts>
struct Traits;
    ...
    , public Descriptor<_Self, _Leaf>
{
  ...
  static constexpr bool IsTagged
      = Basic<Descriptor<_Self, _Leaf>>::template IsDerived<_Tag<_Self>>;
};
}  // namespace UD::Interface::Traits
...
concept Tagged
    = (UD::Interface::Traits::Traits<_T>::template IsTagged<_Tag> && ...
       && UD::Interface::Traits::Traits<_T>::template IsTagged<_Tags>);
}
...
{
using DefaultModifiers = UD::Pack::TemplatePack<Modifier::Cloneable>;
template<class... _Ts>
struct Interface;
...
template<class _Derived>
struct Interface<_Derived>
    : public Interface<_Derived,
                       typename Traits::Traits<_Derived>::DirectBases,
                       DefaultModifiers>
{
  ~Interface() override           = default;
  Interface(const Interface&)     = default;
